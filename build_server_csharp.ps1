...
# There was a bug with the assets csproj build target causing the checks.dat not being copied on the first build
...
Write-Output "SPT_VERSION=$SPTVersion" >> "$env:GITHUB_OUTPUT"
